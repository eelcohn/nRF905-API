...
async def set_speed(s_session, host, ssl, username, password, speed, timer):  # pylint: disable=invalid-name
    """Show status."""
...
async def main():
    ...
    parser.add_argument("speed", type=str, help="Speed setting")
    parser.add_argument("timer", type=str, help="Timer setting")
